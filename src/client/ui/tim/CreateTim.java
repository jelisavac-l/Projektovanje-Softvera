 ...
 * @author luka
 */
public class CreateTim extends javax.swing.JDialog {

    /**
     * Creates new form CreateClan
     */
    public CreateTim(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        try {
            kontroleri.KontrolerTim.create(novi);
        } catch (SQLException ex) {
            Logger.getLogger(CreateTim.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        JOptionPane.showMessageDialog(null, "Tim uspešno dodat!", "Sistem", JOptionPane.INFORMATION_MESSAGE);
        this.dispose();
