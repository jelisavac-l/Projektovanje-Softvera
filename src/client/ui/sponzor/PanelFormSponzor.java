 ...
 * @author luka
 */
public class PanelFormSponzor extends javax.swing.JPanel {

    /**
     * Creates new form PanelFormClan
     */
    public PanelFormSponzor() {
        initComponents();
        try {
    ...
    private void initComponents() {
        ...
        if (tblSponzor.getColumnModel().getColumnCount() > 0) {
            tblSponzor.getColumnModel().getColumn(0).setResizable(false);
            tblSponzor.getColumnModel().getColumn(0).setPreferredWidth(12);
            tblSponzor.getColumnModel().getColumn(5).setResizable(false);
        }
